...
class TemperatureUpdateServiceImplTest {
    ...
    void shouldProcessValidCsvFileOnInit() {
        ...
        // then
        verify(fileProcessingStateService).updateProcessingState(stateCaptor.capture(), mapCaptor.capture());
    ...
    void shouldUpdateStateEveryNLines() {
        ...
        // then
        verify(fileProcessingStateService, times(3)).updateProcessingState(any(), anyMap());
    }
    ...
    void shouldRetryOnExceptionAndProcessTheFileWhenNoExceptionIsThrown() {
        ...
        verify(fileProcessingStateService, times(5)).updateProcessingState(any(), anyMap());
    }
}